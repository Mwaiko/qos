...
@section('title', 'Edit Product - Quality Outsource Solutions')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto">
            ...
            <p class="text-lg text-sage-green">
                Update your organic produce information
            </p>
        </div>
    </div>
</section>
        ...
        <div class="bg-cream rounded-lg shadow-xl p-8">
            <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    >{{ old('health_benefits', $product->health_benefits) }}</textarea>
                </div>
                ...
                @if($product->featured_image)
                    <div class="mb-4">
                        ...
                        <div class="flex items-center space-x-4">
                            <img src="{{ asset('storage/' . $product->featured_image) }}" alt="{{ $product->name }}" class="h-24 w-24 rounded-lg object-cover border-2 border-sage-green/30">
                            <p class="text-sm text-sage-green">Upload a new image to replace this one</p>
                        </div>
                    </div>
                @endif
                ...
                <div class="mb-6">
                    <label for="featured_image" class="block text-sm font-semibold text-deep-soil mb-2">
                        {{ $product->featured_image ? 'Update Featured Image' : 'Featured Image' }}
                    </label>
